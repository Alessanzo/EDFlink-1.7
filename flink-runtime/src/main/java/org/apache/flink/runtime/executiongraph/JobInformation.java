...
public class JobInformation implements Serializable {
	...
	public JobInformation(
		HashMap<JobVertexID, ArrayList<Integer>> taskResTypes,
		JobID jobId,
		String jobName,
		SerializedValue<ExecutionConfig> serializedExecutionConfig,
		Configuration jobConfiguration,
		Collection<PermanentBlobKey> requiredJarFileBlobKeys,
		Collection<URL> requiredClasspathURLs) {
		this(jobId, jobName, serializedExecutionConfig, jobConfiguration, requiredJarFileBlobKeys, requiredClasspathURLs);
