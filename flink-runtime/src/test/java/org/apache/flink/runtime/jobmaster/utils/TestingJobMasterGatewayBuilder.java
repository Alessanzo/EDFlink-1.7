...
public class TestingJobMasterGatewayBuilder {
	...
	private BiFunction<Map<String, Integer>, RescalingBehaviour, CompletableFuture<Acknowledge>> rescalingOperatorsFunction = (ignoredA, ignoredB) -> CompletableFuture.completedFuture(Acknowledge.get());
	...
	public TestingJobMasterGatewayBuilder setRescalingOperatorsFunction(BiFunction<Map<String, Integer>, RescalingBehaviour, CompletableFuture<Acknowledge>> rescalingOperatorsFunction) {
