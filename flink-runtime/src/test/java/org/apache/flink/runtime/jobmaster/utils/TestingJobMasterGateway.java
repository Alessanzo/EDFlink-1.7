...
public class TestingJobMasterGateway implements JobMasterGateway {
	...
	@Nonnull
	private final BiFunction<Map<String, Integer>, RescalingBehaviour, CompletableFuture<Acknowledge>> rescalingOperatorsFunction;
	...
	public TestingJobMasterGateway(
			...
			@Nonnull BiFunction<Map<String, Integer>, RescalingBehaviour, CompletableFuture<Acknowledge>> rescalingOperatorsFunction,
	...
	@Override
	public CompletableFuture<Acknowledge> rescaleOperators(Map<String, Integer> operators, RescalingBehaviour rescalingBehaviour, Time timeout) {
		return rescalingOperatorsFunction.apply(operators, rescalingBehaviour);
	}
